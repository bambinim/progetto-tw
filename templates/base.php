        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse offcanvas-collapse">
                <div class="offcanvas-header">
                    <button type="button" class="btn-close text-reset" aria-label="chiudi" id="offcanvasCloseButton"></button>
                </div>
            ...
            <div id="nav-icons" class="d-flex">
                <?php if (!is_null($user)) : ?>
                    <div class="dropdown" id="notification-dropdown">
                        <button class="btn btn-link link-dark shadow-none" type="button" id="notification-bell" aria-label="notifiche" aria-expanded="false" data-bs-toggle="dropdown">
                ...
                <?php if (isset($user)) : ?>
                    <div class="dropdown mobile-hidden">
                        <button type="button" id="account-button" class="btn btn-link link-dark shadow-none" aria-label="account" aria-expanded="false" data-bs-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="account-button">
                            ...
                            <li><a class="dropdown-item" href="/logout"><span class="fas fa-sign-out-alt me-1"></span>Esci</a></li>
                        </ul>
                    </div>
                <?php else : ?>
